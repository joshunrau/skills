  ...
  return (
    <motion.button
      ...
      animate={{
        ...
        boxShadow: isPressed ? '0 0 0 4px rgba(99, 102, 241, 0.3)' : '0 0 0 0px rgba(99, 102, 241, 0)'
      }}
    ...
    <>
      ...
      >
        {images.map((image, index) => (
          ...
          >
            <img src={image.thumbnail} alt={image.alt} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
          </motion.div>
        ))}
      </div>
